...
public abstract class MasterView extends JPanel
{
	...
	protected JLabel createImageLabel(String index)
	{
		ImageIcon basecard = CardsImagesResource.getCardImage(index);
	...
	{
		JLabel returnlabel = new JLabel(Utils.createTransparentIcon(72, 96));
		returnlabel.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1, true));
		return returnlabel;
	}
	...
	{
		CasinoFrame.setCurrentPanelInParentFrame(this);
		parentFrame.updatePanel(this);
	}
	
	public void refreshView()
	{
		parentFrame.remove(CasinoFrame.getCurrentPanelInParentFrame());
		parentFrame.updatePanel(this);
		CasinoFrame.setCurrentPanelInParentFrame(this);
	}
